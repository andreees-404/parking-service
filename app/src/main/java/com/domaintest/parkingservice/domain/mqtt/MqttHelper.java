...
public class MqttHelper implements ViewModelStoreOwner {
    // Test token: mqtt://kittyreader:9KlFcsHqzQjn25aH@kittyreader.cloud.shiftr.io
    ...
    private static String mHost = "tcp://parkingservice:uvGKmWxxmzeLBP4@parkingservice.cloud.shiftr.io";
    private static String mUser = "parkingservice";
    private static String mPass = "uvGKmWxxmzeLBP4";
    ...
    private void subTopic() {
        ...
        client.setCallback(new MqttCallback() {
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                Log.d(TAG, "messageArrived: Message arrived!" + new String(message.getPayload()));
    ...
    public void handleMessage(String topic, MqttMessage msg) {
            try {
                Log.d(TAG, "handleMessage: init: " + topic);
                if (topic.equals("disponibles")) {
                        lastReceivedMessage = new String(msg.getPayload());
                        Log.d(TAG, "handleMessage: " + new String(msg.getPayload()));
                        // Update msgVidemodel
                        if (messageListener != null){
                            messageListener.accept(lastReceivedMessage);
                        }
                        setMessage(messageViewModel, lastReceivedMessage);
    ...
    public void setMessage(MessageViewModel viewModel, String msg) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(TAG, "setMessage: " + viewModel.getMessage().getValue());
            }
        });
    }
